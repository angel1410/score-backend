...
// ✅ Obtener de cedula_relacionada en vez de id_accion
pub async fn get_carga_masiva_id_by_log(
    ...
    match sqlx::query_scalar::<_, i32>(
        r#"SELECT cedula_relacionada FROM logs WHERE id = $1 AND accion = 'CARGA MASIVA DE USUARIOS'"#
    )
    .bind(log_id)
    ...
    .await
    {
        ...
        Ok(None) => HttpResponse::NotFound().json(serde_json::json!({ 
            "error": "Log no encontrado o no es carga masiva" 
        })),
